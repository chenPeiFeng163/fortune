    ...
    <div class="table">
        <div class="container">
                ...
                <el-form :inline="true" class="demo-form-inline">
                    ...
                    <el-form-item label="状态:">
                        <el-checkbox-group v-model="flow_state">
                            ...
                            <el-checkbox label="废弃" name="state"></el-checkbox>
                        </el-checkbox-group>
                    </el-form-item>
                    <el-form-item>
            ...
            <el-table :data="data" border style="width:100%" ref="multipleTable">
                <el-table-column prop="englishName" label="岗位名称" width="150" align="center">
                </el-table-column>
                <el-table-column prop="empNo" label="岗位编号" width="100" align="center">
                </el-table-column>
                <el-table-column prop="personnelBelongs" label="所属公司" align="center">
                </el-table-column>
                <el-table-column prop="applicationCon" label="更新时间/操作人" align="center">
                </el-table-column>
                <el-table-column prop="currentNodes" label="状态" width="120" align="center">
                </el-table-column>
        ...
        <!-- 新增弹出框 -->
        <el-dialog title="岗位维护 - 新增" class="dialog-big" :visible.sync="addVisible" :close-on-click-modal="false">
            <div>
                <el-form :inline="true" class="demo-form-inline">
        ...
        <!-- 查看弹出框 -->
        <el-dialog title="岗位维护 - 查看" class="dialog-big" :visible.sync="lookVisible" :close-on-click-modal="false">
            <div class="look-module">
                <div class="head"><img class="icon" src="static/img/comm/icon_data01.png" />基础信息</div>
                <div class="body">
                    <table class="table-data">
        ...
        <!-- 编辑弹出框 -->
        <el-dialog title="岗位维护 - 编辑" class="dialog-big" :visible.sync="editVisible" :close-on-click-modal="false" width="600px">
