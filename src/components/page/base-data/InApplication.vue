<template>
    ...
    <div class="table">
        ...
        <!-- 新增弹出框 -->
        <el-dialog title="人员入职申请 - 新增" class="dialog-big" :visible.sync="addVisible" :close-on-click-modal="false">
        ...
        <!-- 查看弹出框 -->
        <el-dialog title="人员入职申请 - 查看" class="dialog-big" :visible.sync="lookVisible" :close-on-click-modal="false">
            <div class="look-module">
                <div class="head"><img class="icon" src="static/img/comm/icon_data01.png" />基础信息</div>
                <div class="body">
                    <table class="table-data">
        ...
        <!-- 编辑弹出框 -->
        <el-dialog title="人员入职申请 - 编辑" class="dialog-big" :visible.sync="editVisible" :close-on-click-modal="false">
            <div class="look-module">
                <div class="head"><img class="icon" src="static/img/comm/icon_data01.png" />基础信息</div>
                <div class="body">
                    <table class="table-data">
