    ...
    <div class="table">
        <div class="container">
            ...
            <el-table :data="data" border style="width: 100%" ref="multipleTable" :default-expand-all="true">
                ...
                <!--<el-table-column prop="jurisdiction" label="申请权限" width="100" align="center">
                    <template slot-scope="scope">
                        <a class="look-a" href="javascript:;">查看</a>
                    </template>
                </el-table-column>-->
...
<script>
    export default {
        name: 'personnelaccreditapplication',
        data() {
            return {
                tableData: [],
                cur_page: 1,
